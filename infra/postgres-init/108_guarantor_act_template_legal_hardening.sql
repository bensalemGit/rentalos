-- 108_guarantor_act_template_legal_hardening.sql
-- Durcissement juridique de l'acte de cautionnement.
-- Ne modifie pas les PDF déjà générés ; s'applique aux prochaines générations.
...
<p>
  La caution renonce expressément au bénéfice de discussion et s'engage solidairement avec le locataire garanti,
  de sorte que le bailleur pourra poursuivre directement la caution sans avoir à poursuivre préalablement le locataire.
</p>
...
<p>
  ...
  ainsi que pour une seule reconduction ou un seul renouvellement express du bail,
  sans pouvoir excéder une durée totale de 24 mois à compter de la date de prise d'effet du bail.
</p>

<p>
  En cas de départ du locataire garanti dans le cadre d'une colocation, l'engagement de la caution prend fin
  dans les conditions prévues par l'article 8-1 de la loi du 6 juillet 1989 : à la date d'effet du congé
  si un nouveau colocataire figure au bail, ou à défaut au plus tard six mois après cette date.
</p>

<h2>5. Montants de référence et plafond</h2>
...
<p>
  Le présent cautionnement est consenti dans la limite d'un montant maximal de {{guarantee_cap_eur}} €,
  correspondant à 24 mois de loyers charges comprises.
</p>

<p>
  Ce montant constitue le plafond global de l'engagement de la caution, couvrant l'ensemble des sommes dues
  par le locataire garanti au titre du bail, y compris les loyers, charges, indemnités d'occupation,
  réparations locatives, frais et accessoires, dans les conditions prévues au bail et par la loi.
</p>

<h2>6. Mention de la caution</h2>

<p>
  En me portant caution de {{guaranteed_tenant_full_name}}, dans la limite de la somme de {{guarantee_cap_eur}} €
  ...
  et mes biens si {{guaranteed_tenant_full_name}} n'y satisfait pas lui-même.
</p>
