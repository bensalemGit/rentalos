-- 104_guarantor_act_template_target_tenant.sql
-- Clarifie l'acte de caution : 1 acte = 1 garantie = 1 locataire garanti.
-- Ajoute durée + plafond pour robustesse juridique.
-- Ne modifie pas les documents déjà générés ; s'applique aux prochaines générations.
...
<p>
  Le présent cautionnement est consenti pour toute la durée du bail initial,
  ainsi que pour ses éventuels renouvellements ou reconductions, dans la limite
...
<p>
  Le présent cautionnement est consenti dans la limite d’un montant maximal
  équivalent à 24 mois de loyers charges comprises, soit à titre indicatif
  {{rent_eur}} € × 24, majoré des charges, réparations, indemnités et accessoires.
</p>
